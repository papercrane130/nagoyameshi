...
//        }
    ...
    {        
        ...
        LocalDate fromCheckinDateToCheckoutDate = reservationInputForm.getCheckinDate();
//        LocalDate checkoutDate = reservationInputForm.getCheckoutDate();
 
        // 宿泊料金を計算する
//        Integer lowestPrice = restaurant.getLowestPrice();        
//        Integer amount = reservationService.calculateAmount(checkinDate, checkoutDate, lowestPrice);
        
        ReservationRegisterForm reservationRegisterForm = new ReservationRegisterForm(restaurant.getId(), user.getId(), fromCheckinDateToCheckoutDate.toString(), reservationInputForm.getNumberOfPeople());
